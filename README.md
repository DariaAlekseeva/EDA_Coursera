...
1. .rmd code for this project. To create the same plots you need to download file in your wd and run the code.
2. .html which was knitted in Rstudio.
3. README file
4. Link to this project in Rpubs: http://rpubs.com/Daria/56842
